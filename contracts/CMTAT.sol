    ...
    LocalListModule
{
     ...
     */
    function addToLocalWhitelist(
        address[] memory wallets
    ) external override onlyRole(LIST_ROLE) {
    ...
    function setOwner(
        ...
        require(
            ...
            "CMTAT Authorization: Signers are equal"
        );
        require(
            signatureData1.signer != _msgSender() &&
                signatureData2.signer != _msgSender(),
            "CMTAT Authorization: Signers can't be caller of function"
        );
        require(
            hasRole(GUARDIAN_ROLE, signatureData1.signer),
            "CMTAT Authorization: Signer1 doesn't have GUARDIAN_ROLE"
        );
        require(
            hasRole(GUARDIAN_ROLE, signatureData2.signer),
            "CMTAT Authorization: Signer2 doesn't have GUARDIAN_ROLE"
        );
        require(
            !usedSignatures[signatureData1.signature],
            "CMTAT Authorization: Signature of Signer1 already used"
        );
        require(
            !usedSignatures[signatureData2.signature],
            "CMTAT Authorization: Signature of Signer2 already used"
        );
        require(
            verify(
            ...
            "CMTAT Authorization: Signature verification failed"
        );
        require(
            verify(
        ...
        //TODO: ROLES ARE NOT GETTING REVOKED?
    ...
    function _grantAllRoles(address account) internal {
        ...
        _grantRole(ENFORCER_ROLE, account);
    ...
    function _revokeAllRoles(address account) internal {
        ...
        _revokeRole(ENFORCER_ROLE, account);
